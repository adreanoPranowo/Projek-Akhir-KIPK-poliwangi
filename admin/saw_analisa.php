				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						<div class="box-header">								
							...
							<a href="saw.php" class="btn btn-warning btn-sm pull-right"> Kembali</a>
						</div>	
					</div>
					<div class="panel-body">
						...
						<div class="box box-primary box-solid">
							...
							<form action="saw_analisa.php" method="GET">
								<table class="table table-bordered">
									<tr>
										<td>
						...
						if(isset($_GET['filter'])){
							...
							?>
							<br>
							<a href="saw_print.php?id=<?php echo $idpr?>&filter=<?php echo $filter ?>" class="btn btn-sm btn-primary" target="_blank"><i class="icon-PRINT"></i> PRINT HASIL</a>
							<br>
							<br>
							<div class="box box-primary box-solid">
								<div class="box-header">
